...
fairratio=0.0168;%Fuel to air ratio of said fuel
nair=1;%Initial amount of air in mol
Umol=-5109000;%Internal energy of reaction per mol
nexh=1.075;%mol of exhaust gas per mol air+requisite fuel
nfuel=fairratio*nair;%Number of moles fuel per mol air required in your setup
%intermediate calcs
R=0.0832;
