...
T2=fsolve(@(T2) stage1(T2,T1,P1,CR),600,optimset('Disp','off'));
T3=fsolve(@(T3) stage2(T3,T2,xco2_2,xn2_2,xwat_2,nfuel,Umol),1000,optimset('Disp','off'));
T4=fsolve(@(T4) stage3(T4,T3,xn2_2,xwat_2,xco2_2,v3,v4),600,optimset('Disp','off'));
...
Erats=[Erats; Erat;];
Efficiencys=[Efficiencys; Efficiency;];
U3s=[U3s; U3;];
U1s=[U1s; U1;];
T2s=[T2s; T2;];
T3s=[T3s; T3;];
...
xlswrite('Piston properties.xlsx',[CRs Erats Efficiencys U3s U1s T2s T3s T4s],1,'A2');
