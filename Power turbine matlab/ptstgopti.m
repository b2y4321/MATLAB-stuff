function a=ptstgopti()

Pentry=1;%Entry pressure

%Outlet pressures to try out
Pcomp1=40;
Pcomp2=100;
Pcompincr=1;
%End

Ac=2.5;%Cross sectional area of combustor
n=500;%Mol/s of inlet gas
Enthrxn_298=870000;
...
T2=fsolve(@(T2) ptstg1(T2,T1,xn2_1,xch4_1,xo2_1,P1,P2),1000,optimset('Display','off'));
T3=fsolve(@(T3) ptstg2(T3,T2,xn2_2,xo2_2,xh2o_2,xco2_2,xch4_precombust),1000,optimset('Display','off'));
T4=fsolve(@(T4) ptstg3(T4,T3,xn2_3,xo2_3,xh2o_3,xco2_3,P3,P4),1000,optimset('Display','off'));
...
EnergyRatio=-Enth3/Enth1;
Effic=[Effic; Efficiency;];
enratio=[enratio; EnergyRatio;];
Press=[Press; Pcomp;];
entryvel=[entryvel; velocity2a;];
exitvel=[exitvel; velocity2b;];

Pcomp=Pcomp+Pcompincr;

end
xlswrite('Statistics.xlsx',[Press Effic enratio entryvel exitvel]);
