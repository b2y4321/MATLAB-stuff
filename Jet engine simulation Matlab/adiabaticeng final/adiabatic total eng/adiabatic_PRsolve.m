...
xlswrite('jetenginestats_PR.xlsx',{'Inlet P in bar','Inlet T in K','Compression Pressure','Outlet Pressure'}); 
xlswrite('jetenginestats_PR.xlsx',[P1 T1 P2 Pdisch],1,'A2');
xlswrite('jetenginestats_PR.xlsx',{'Internal pressure bar' 'Moles air inlet/mol fuel' 'Moles resultant gas/mol fuel' 'Tfin of compressor stage' 'Enthalpy of compressor stage KJ/mol fuel','Tout of combustion stage','Energy lost during combustuion KJ/mol fuel','Temperature celing vs calculated difference','Tout of nozzle stage','Enthalpy of nozzle stage KJ/mol fuel','Net energy ratio Production/consumption','Absolute Efficiency without bypass','Molar Kinetic Energy','Exhaust velocity m/s without bypass'},1,'A3');
xlswrite('jetenginestats_PR.xlsx',[Ps Nmuf MrgUf Tfins htots Tcomb2s Eheatlosses TempDiffs Te2s hetots ratios AbsEffs MKEs Evels],1,'A4');